...
function Header() {
  return (
    <header className="p-4 bg-gray-900 text-gray-100">
      <div className="container flex h-16 mx-auto justify-center">
        <button aria-label="Back to homepage" className="flex items-center p-2">
          <svg
